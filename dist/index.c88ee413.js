...
latMinSL.addEventListener("change", function() {
    document.getElementById("latMinL").textContent = "Min Latitude: " + latMinSL.value;
    resetBoundingBox();
    getData();
});
latMaxSL.addEventListener("change", function() {
    document.getElementById("latMaxL").textContent = "Max Latitude: " + latMaxSL.value;
    resetBoundingBox();
    getData();
});
lonMinSL.addEventListener("change", function() {
    document.getElementById("lonMinL").textContent = "Min Longitude: " + lonMinSL.value;
    resetBoundingBox();
    getData();
});
lonMaxSL.addEventListener("change", function() {
    document.getElementById("lonMaxL").textContent = "Max Longitude: " + lonMaxSL.value;
    resetBoundingBox();
    getData();
});
...
minTempSL.addEventListener("change", function() {
    ...
    document.getElementById("minTempL").textContent = "Min temp: " + minTempSL.value;
    getData();
    minTempSL.setAttribute("label", minTempSL.value);
});
maxTempSL.addEventListener("change", function() {
    maxTemp = maxTempSL.value;
    document.getElementById("maxTempL").textContent = "Max temp: " + maxTempSL.value;
    getData();
});
